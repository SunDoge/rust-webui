...
#[test]
fn bindgen_test_layout_webui_event_t() {
    const UNINIT: ::std::mem::MaybeUninit<webui_event_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<webui_event_t>(),
        40usize,
        concat!("Size of: ", stringify!(webui_event_t))
    );
    assert_eq!(
        ::std::mem::align_of::<webui_event_t>(),
        8usize,
        concat!("Alignment of ", stringify!(webui_event_t))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).event_number) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(webui_event_t),
            "::",
            stringify!(event_number)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).bind_id) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(webui_event_t),
